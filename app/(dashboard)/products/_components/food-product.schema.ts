...
// 상품 등록
export const foodProductCreateSchema = foodProductBaseSchema
  .extend({
...
export type FoodProductCreateInput = z.input<typeof foodProductCreateSchema>;

export type FoodProductCreateValues = z.output<typeof foodProductCreateSchema>;

export type FoodProductEditInput = z.input<typeof foodProductEditSchema>;

export type FoodProductEditValues = z.output<typeof foodProductEditSchema>;

// 기존 컴포넌트 호환
export type FoodProductFormInput =
  | FoodProductCreateInput
  | FoodProductEditInput;

export type FoodProductFormValues =
  | FoodProductCreateValues
  | FoodProductEditValues;
